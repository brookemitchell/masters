...
*** ~rhetoric of systems, communities and information flow.[fn:35]
*** "Beer argued that technolgy could be political in other ways. He beleived that creating a technoligical system entailed developing a technolgy that could be integrated into a social and organisational context. This, engineering a technolgy also provided opportunities to engineer the social and organisational relationships that surrounded it.[fn:34]"
* Introduction
***  Opening Quote:
     /Although it is tempting to reduce a technoligical system to its hardware, historians of technology have shown that technological systems are a "seamless web" of social, institutional and technoligical relationships.(122)/
*** REVIEW The Social and the Surveillant

     Parasite Suite is collection socially-orientated art works exploring attitudes and reactions to digital technology.


 The project is realised using a set of art projects that meditate on the theme of 'computationality'. This term I define as a combination of computer processing and networking capabilty that embody a particular aesthetic and mode of experience for those that interact with the works [fn:1]. The particulars of the experience and aesthetic of 'computationality' has been specifically collected and outlined by others[fn:30] but here I loosely define it as the experiencne of a real world decision that seems more determined by what would be appropriate for the sensibilities of a machine rather than a human.
