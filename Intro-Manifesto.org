...
*** DONE
*** REVIEW
    Parasite Suite is collection of works exploring socially orientated  methods for creative engagement with digital technology. The project is realised using audible art projects that meditate on the theme of 'computationality'. The term 'Computationality' I define to mean the combination of computer processing and  various forms of networking that in combination become a particular aesthetic and mode of experience for those that interact with the works [fn:1]. As social participants, a key function of the works is to create scenarios for the role of participants to dramatically shift. The projects are intended to be open ended and generative, blurring lines between artist and audience.
*** EDIT
**** p1.
