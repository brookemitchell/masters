...
For example, , if I was to write a program that could recognise and intention to read the paragraph that you are currently reading. A program might consist of a tracking of the
