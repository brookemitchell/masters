...
** REVIEW Abstract
   ...
   'Parasite Suite' is a collection of works that use social-computing as artistic medium. I wish to explore the phenomenological and aesthetic aspects of compuation using sonically focused art works. The project documents legitimate concerns about social-computing while exploring the systems that produce both awe and anxety. Using social scenarios mediated by computation, the project aims to consider the materiality of computational abstractions, as well their attendant power heirachies. The works use the gallery as a setting for common social-computing techniques, such as data-logging, metadata extraction, computer vision and algorithmic surveillance, these social maipulations hope to provoke consideration of the historical use and influences behind many computation techniques. I am sugesting that there are many unexplored or neglected possibilities within computation due to cultural bias and lack of reflexivity about the medium.
...
A mode of revealing is the method by which technologies transform, store and distribute the resources that nature has to offer.'[fn:45]
