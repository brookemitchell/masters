...
The concept of Network Experiecne, and how there is tension between two different models, of how the network shouuld be experienced, or understood, is one of the two central preoccupations of these works.

   'Networked experience' is my term for the phenomenological aspect of social computing. Within a network experience, algorithmic processing acts as a cybernetic facilitator of sensory perception. Video games, pornography, shared coding environments, networked music and robotic surgeries all serve as examples of the emergence of networked sensory systems.
*************** =Interface Effect=
*************** END
Often an interface design is traditional in its choice of sensory paradigms, choosing to emulate interface models of the past[fn:70]. However, occasionally an experience, like email messaging, radically changes the form of a design at many levels.[fn:74]
 ...
 The common characteristics of hyper-media are for; cross-referencing, editing, levels of detail and multi-directional-links between each of these features, where all proposed features of hyper-media as written about from =history of people developing hyper-media=. Not all of these features were used by the hyper-text-markup-language, as was the original intention for the concept of hyper-media as espoused by Ted Nelson in Dream Machines.[fn:80]

 One of first widely noted hypermedia examples was not text-centric, rather it was an interactive video application for path finding through the city of Aspen, with video displaying a multi detailed map of Aspen mixed into the skyline, the application was developed a manner similar to google maps[fn:82]. Yet text and images are often privileged forms of interaction online, a reversal of the dominance of speech acts over text[fn:65]. Although there is a rich variety of media types on the internet, it seems though it is text that is by far the most 'hyper' in its ability to be distributed, cross referenced, linked and have form separate from content. Aspects of this are open to remedy, and in the sound world this has driven my interest in the Web Audio and MIDI APIs[fn:72] For these projects I wish to explore the role of auditory senses in the network.
