...
* Parasite Suite - Works on the use of social-computing in art.

* Abstract

  The project titled 'Parasite Suite' is about exploring the potential of new kinds of social engagements made possible with the use of computers. The goal of the project is create sonically affective art works that elicit considerations about the potentials and pitfalls caused in the mediation of social engagement by the technological metaphor of 'computation'.

  The method to achieve this is to delve into some of these legitimate concerns by making transparent some of the processes, such as data-logging, algorithmic extraction of large data sets and sensory information and algorithmic surveillance and using them as key elements of the art works.

  By sonically and visually 'reifiying' the social manipulations that machines can introduce and altering their usage beyond what is traditionally seen in surveillance, such as exploring the concept of 'sousveilance' it is hoped that... I can use 'social-computing' as a productive concept to explore the contours of other technologies taht use similar technologies we enage with on a constant basis.
* EDIT Introduction
** Quotes
...
** EDIT Networked Experience and Digital Asethetics

   Parasite Suite is collection of socially-orientated art works exploring the role of technology in human relations. The works are inspired by anxieties about technology, now that much of computerisation of relations is normalized as a constant in the lives of most beings. The works particularly focus on concerns about government and institutional use of surveillance. The works are based on stuides toward a critical theory of the digital, works of information theory, as well as works by composers with an interest in the relationship between technology and society =such as...=. The project is realised as a set of installations that consider the contour of social engagements for those contending with a 'computational' mindset, a neologism which will be described following.

    The notion of a 'computational' mindset is concept introduced by David Berry[fn:42],  is a continuation of the idea of 'enframing' developed by Martin Heidegger in "The Question Concerning Technology"[fn:3]. 'Enframing' describes how technology mediates our engagements with the world, but also how qualities of a technology are adopted as metaphors for other sytems, paticularly economic and social. Furthermore, technology has a 'mode-of-revealing'[fn:4] that can import influence over both individuals and societies attitude to the world. In Hedidegger's description, 'enframing' limits understanding of the world, his suggested remedy to this is to limit the extent to which we treat technolgy as a means to mastery of a domain, which allows the use of a technnology to become an end in itslef.[fn:5]

    In this sense we  are reminded of our symbiotic, yet parasitic relationship with technology, we see it as a way to advance understanding, and yet doing so dominates our experiences and potentials. As one of the goals of software seems to be to adopt a simulacrum of 'realness' of the process it is imitating[fn:6], though the use of design or organisation choices. Eventually a sucessful technology can  'dissappear', becoming an unacknowledged part of all experience. =Go on.=

    Berry writes that Heidegger's notion of enframing choses electricity and meta-physics as its two technology metaphors to show as examples. Concepts like 'standing-reserve',  (a mobilistation of labour or capitial waiting to be activiated once the correct connections  are made) are closely related to the concept like voltage potential. Berry's notion of 'computationality' as a way of being, is corresponding based on metaphors from networking and software engineering. I hope to employ computationality as a method to analyse engagements and make conceptual, material and deisgn choices as approachable as possible for analysis. I have attempted this by designing engagments that appear to emphasise technicity but on participant involvement social engagement over-rides technological mediation of a social scenario.
...
Berry describes is as a phenomenological message system[fn:7] because of the mode of thinking about twitter encourages users to describe their experience of a particular moment (with their smartphone) in the most immediate terms possible.
...
This leads to famous phrases that seem typical of the present such as "all you need is data" [fn:9]. However these data streams also have trajectories, and sources, controlled by physical infrastructure and logistics, controlled by powerful entities. Like a water company.
...
deepen rathr than disappear.[fn:40] a classic text describing this
