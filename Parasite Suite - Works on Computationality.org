...
* Introduction
    Parasite Suite is collection socially-orientated art works exploring relations with digital technology in a particpatory environment. The project is realised with a set of art projects that considers the premise that we live in a world where 'computationality' defines our mode of being (otherwise known as ontotheology)[fn:40]. Following the work of David Berry, 'computationality' can be broken into what I feel are its two defining aspects, a phenomenology based on networked experience and an aesthetic based on abductive reasoning.

* Networked Experience
  The manner in which humans order and recognise the world can be considered open to influence and changes based on environmental trends and epistemeological shifts. I contend that the metaphors that shape our experience have shifted since the turn of the 21st century. In a society experiencing constant engagment with software algorithms[fn:43] today's engagements with the world order themselves around the metaphor of the 'stream' of revelation[fn:44]. The experience of considering oneself both a recipient and generator of the 'stream', is one of the defining characterstics of networked experience. If participants are indeed ordering their world in response to 'streams,' then typical goals include processing information, performing algorithmic transformations, and searching for ways to filter information to make it /computeable/, which leads into to our second quality of computationality, recognising patterns through abductive reasoning.
