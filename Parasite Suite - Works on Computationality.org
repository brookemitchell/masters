...
* EDIT Abstract
  ...
  'Parasite Suite' is a collection of works exploring the usage art works about social-computing, computational systems focused on social behavior (hencesforth referred to as 'computationality'). The project aims to consider theoretical aspects of social-computing through sonically engaged art works, with the aim of presenting the materiality of computational processes and algorithms, as well as their attendant power heirachies. The intention is to document some legitimate concerns about the current social-computing climate by making transparent some of the processes and techniques to audiences that might be less familiar. Techniques such as data-logging, metadata extraction from data sets, sensory information and algorithmic surveillance, using these as key elements of the art works. By sonically and visually reifiying the social manipulations that machines can introduce and employing their usage beyond common scenarios, it is hoped that I can use social-computing as a productive concept to explore the contour of the political and economic aspects of modern computing.
...
** EDIT Introduction
   ...
   Parasite Suite is collection of socially-orientated art works inspired by anxieties about technology, now computerised relations are normal in the lives of most beings. The works particularly focus on concerns about government and institutional use of surveillance. References include critical theories of the digital[fn:43] , as well as works by composers and artists with an interest in the relationship between technology and society =such as...= . The project is realised as a set of installations that consider the types of social engagements open to exploration for those entertaining a 'computational' mindset, a neologism which will be described.

    The notion of a 'computational' metaphor is concept introduced by David Berry in his book 'Critical Theory and the Digital'.[fn:42] The computational is a way of being, where the ordering of the world is influenced by metaphors derived from the mediums which predominate interaction; in this case networked computer devices. The concept owes much to the work of Neil Postman, Mashall Mcluhan and is especially is a continuation of the idea of 'enframing' developed by Martin Heidegger in "The Question Concerning Technology"[fn:3]. 'Enframing' describes how technology mediates our engagements with the world, but also how qualities of a technology are adopted as metaphors for other sytems, paticularly economic and social.

    Technology has a 'mode-of-revealing'[fn:4] that can import influence over both individuals and a societies attitude to the world. In Hedidegger's description, 'enframing' allows a technology to gain widespred understanding, but also limits alternate understandings of the world, which is a dilemna to be cautious of.  Heidegger's suggested remedy to this is to limit the extent to which we treat technolgy as a means to mastery of a domain, which allows the use of a technnology to become an end in itslef, however that is more esasily said than done when technology often aspires to simulacrum, abstraction and transparency.[fn:5]
...
** EDIT Networked Experience
   ...
   'Networked-Experience' is the term for the kind of sensory expectations and engagements with the world that develop when we delve into a world of high speed data. These expectations are based on the previous experiences of the 'revealing' of a technologically infused natural world.


 'Streaming-forth' is the characteristic 'mode-of-revealing' for networked experience.

A 'mode-of-revealing' is the method by which a technology 'unlock, transform, store and distribute the resources that nature has to offer.'

 An enourmous amount of computational power is now directed towards the relaying, processsing and filtering of data sets, to be used in methods such as translation, aggregation, advertising and archiving. The use of computation to expand the function of communications has been ubiquitous since the invention of email.

The quintessential example of real time production and archiving is Twitter, a near real-time worldwide message archive service. One that has till recently performed poorly as an archiving service but functioned efficently as a real time message sharing service.
...
** EDIT Abductive reasoning in practice Digital Aesthetics are :- paradigm, goal, paradigmatic epistem
