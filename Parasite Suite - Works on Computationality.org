...
** REVIEW Networked Experience and Digital Asethetics
...
** REVIEW Make this sharper
 ...
 I will be reffering to this 'computational' attitude as 'computationality' henceforth. I believe the term 'computationality' can be broken into two key components, an understanding of relations based on the 'network as metaphor', and a sympathy for thinking patterns are based on abductive reasoning.

** REVIEW Network as Metaphor
