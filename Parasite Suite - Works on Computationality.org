...
* DONE Introduction
  Parasite Suite is collection socially-orientated art works exploring human relations with digital technology. The project is realised as a set of art projects that consider the premise that 'computationality' strongly influences our perception of the world. The term 'computationality' can be broken into two defining aspects, an perception of relations and experience as networked, and an sympathy for thinking patterns based on abductive reasoning. I shall elaborate on the meaning of these terms further.

Perceiving the world as based on networking is an emergent metaphor for relations that David Berry identifies in his book 'Digital Criticism'/?. The 'network as meataphor' is described a post-modern elabororation of a trend identified by Martin Hedegger that the worlds' 'Mode of Revealing'was closely related to  the use of technology as metaphor. Heidegger describes his times  mode of revealing 'challenging-forth', a notion Berry posits as based on the influence of modern physics and particularly electricity, where humans are placed as 'standing-reserve', and talked about in electrical metaphors suchh as 'potential'. berry declares a post-modern technology metaphor that has emerged based on 'Streaming-forth', a concept related to real-time networks[fn:2].
