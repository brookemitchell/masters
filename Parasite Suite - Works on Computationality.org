...
Computational ontology - ordering of the based on distinction / abductive reasoning
   ...
   Parasite Suite takes anxiety regarding technology as a starting point, particularly concerns about government and institutional use of surveillance, now that much of the amazement and sublimity of networked computing has worn off. References include critical theories of the digital,[fn:43]  as well as works by composers and artists with an interest in the relationship between technology and society =such as...= . The project is realised as a set of 3 installations that consider the types of social engagements open to exploration for those entertaining a 'computational' attitude, a neologism which will now be described.

    The notion of a 'computational' attitude is concept described by David Berry in his book 'Critical Theory and the Digital'.[fn:42] The computational is a way of being, where the ordering of the world is influenced by metaphors derived from the mediums which predominate interaction; in this case networked computer devices. The concept owes much to the work of Neil Postman, Mashall Mcluhan and is particularly a continuation of the idea of 'enframing' developed by Martin Heidegger in "The Question Concerning Technology"[fn:3]. 'Enframing' describes how technology mediates our attitudes with nature, but also how qualities of a technology are adopted as metaphors for other sytems, paticularly economic and social.
...
** EDIT Networked Experience - Concealment of Technology.
