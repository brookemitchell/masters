...
Correlationist principle. Real can be communicated. Laurelle.[fn:10]

Site vs Non-Site [fn:11]
...
Software as a /super-medium/ that unifies other forms,  (tv/film/radio/print), rather than containing them it reforms and reshapes them into a "new unitary form"[fn:16] "this super-medium acts as both a meditating and structuring frame that we must understand through its instantiation under particular physical constraints" - rejecting the immateriality of software. analysing the doing, platform studies.

the terms 'softwarized society' coined by David berry [fn:17] encapsulates what I see as the outcome of networked experience and computational aesthetics.

As technology inculcates itself we are in danger of forgetting how entangled with computer code we really are, software is part of the narrative of our lives, and yet often overlooked. fuller (2006) notes, "in a sense, all intellectual work is now 'software study', in that the software provides its media and its context..." Berry encourages us to think about the "structure of feeling[fn:18]"  and methods of usefulness permitted by code. noting that technology is a cultural metaphor as well as lexical and physical object. these varied cultural thoughts about technology in relation to the self and society inform practice and engagement with tools as well as wider social and economic relations. to the extent that berry believes the metaphors of software in particular, to form a 'plane of immanence' that shapes relations[fn:19].

in my attempt to consider the design and implementation of tools like computer vision, real-time communication and data-collection, i have often found that the design and user experience as a developer is often imprinted with the culture and expectations of the teams that assembled the foundations of these tools[fn:20]. in a sense i have discovered  a source for my own anxiety in a consciousness of the kind of corporate cultures values embedded in the design of systems. my response to this has been to try and configure atypical user interfaces and methods of engagement, such as avoiding the user metaphor of a person sitting at a computer terminal with keyboard and mouse, and trying to treat sound as a first-class user interaction medium[fn:21].

in this sense the work is inspired by concepts such as 'sousveillance'[fn:22] where a technology is levelled against an oppressor rather than the opposite. in my course of exploring how to 'turn the tables' however, i have also found that it is often the composition of technologies and the relationships that their design encourages[fn:23], that require the formulation of organic and locally specific technologies that offer solutions more relevant in my case for an artistically inspired, more affecting outcome, and on a general level benefit participants.
...
[fn:10] Galloway, 10 Theses on the digital

[fn:11] LEAVol19No1-McGarrigle.pdf

[fn:12] link to weiner

[fn:13] link de landa, berry.

[fn:14] idea taken from the talk,"the web that wasn't" )[[webthatwasnt][twtw]]

[fn:15] link to deetails on javascript streams

[fn:16] berry 10

[fn:17] softwareised society, link opening of phil of software on dependance on software for survival. berry p.

[fn:18] berry, p. 6.

[fn:19] berry and deleuze, p. 18.

[fn:20] link to classic essay about design of saftware informed

[fn:21] any links to this? there was a bit from deland

[fn:22] sousveilance

[fn:23] foucoult link, design of software and oppression

[fn:24] Wikipedia social computing https://en.wikipedia.org/wiki/Social_computing

[fn:25] From "Social Computing", introduction to Social Computing special edition of the Communications of the ACM, edited by Douglas Schuler, Volume 37 , Issue 1 (January 1994), Pages: 28 - 108

[fn:26]

[fn:27] From "Social Computing", introduction to Social Computing special edition of the Communications of the ACM, edited by Douglas Schuler, Volume 37 , Issue 1 (January 1994), Pages: 28 - 108

[fn:28] http://www.slate.com/articles/technology/bitwise/2015/01/black_box_society_by_frank_pasquale_a_chilling_vision_of_how_big_data_has.html

[fn:29] Paper on organisation structure affecting software design

[fn:30] Theories of the Digital

[fn:31] Put refs for all tehse people here

[fn:32] 'Critical Theory and the Digital'

[fn:33] Heidegger notes in /Being and Time/ that the priveleging of the present has a *parasitic* relationship with the concept of time. This could be extended.

[fn:34] heidegger qct

[fn:35] Waddington 577

[fn:36] Waddington 577

[fn:37] (Harries, 1994, p. 233) IN Waddinton 577

[fn:38] Enframing Heidegger p.2

[fn:39] Second ceoncealment Heidgger

[fn:40] Berry on 'super-mediums'

[fn:41] Ref to Application layer of TCP/IP

[fn:42] /E-mail emerged in 1971 when users began experimenting with ways of sending electronic messages from one networked computer to another. in her study of the internet's origins, Janet Abbate writes that e-mail "remade" the arpanet system and caused it to be see 'not as a computer system but rather as a communication sytem/ (ref.82) 1.[fn:5]

[fn:43] Nelson Dream Machines

[fn:44] One of first widely noted hypermedia examples was an interactive video application for path finding through the city of Aspen, with video displaying a multi detailed map of Aspen mixed into the skyline, the application very similar to the later google maps.

[fn:45] See Derrida Text v speech.

[fn:46] Web Audio API

[fn:47] Computer Lib

[fn:48] Development of streaming

[fn:49] http://www.hpl.hp.com/techreports/2002/HPL-2002-260.pdf

[fn:50] See the deisgn of TCP/IP, also md5 sums

[fn:51] Streams Programming Languages

[fn:52] See streaming in js, matz pipe language

[fn:53] ref to dependdence on human actors in cybersyn

[fn:54] Cybernetic Revolutionaries

[fn:55] Twitter Sort

[fn:56] Soylent web site

[fn:57] Mechanical Turk

[fn:58] Link california ideology works

[fn:59] /The visions of a free, uncensorable cyberspace envisioned by Barlow, Gilmore and others was incompatible with the needs of Capital, and thus the libertarian impulses that drives Silicon valley caused a change in tune. Cyberspace was no longer a new world, declared independent with its own unalienable rights, it was now an untamed frontier, a wild-west where spooks and cypherpunks do battle and your worth is measured by your crypto slinging skills and operational security... This, as Seda Gurses argues, leads to Responsibilization... Users themselves are responsible for their privacy and safety online. No more unalienable rights, no more censorship resistant mass networks, no more expressing beliefs without fear of being silenced. Hack or be hacked./[fn:74]

[fn:60] repetition of design patterns

[fn:61] (digression on culture)

[fn:62] Pattern Aesthetics

[fn:63] the new Aesthetics

[fn:64] Chip tunes and pixel art

[fn:65] Is the museum a battle field

[fn:66] link between abductive reasoning and ai.

[fn:67] link to uses of term

[fn:68] link to new aesthetic site / files
...
[fn:73] u[fn:9] http://rhizome.org/editorial/2014/oct/22/big-data-little-narration/
