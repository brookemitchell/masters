...
*************** END
     ...
     The project is realised as a set of art projects that consider the premise of 'computationality'. The term describes an approach to, and understanding of the world derived from technology as the primary metaphor for relating to the world, a mode almost akin to internalizing of technocratic politics. I am not interested in making a value judgement about of this state of affairs, as it is one that I exist within. This thread of technolgical thought has a long history, and I wish to ecnourage critical approaches to thinking about and responding to digital culture.

I believe the term 'computationality' can be broken into two key components, particularly for humans. They are an understanding of relations based on the 'network as metaphor', and a sympathy for thinking patterns are based on abductive reasoning.
