...
* Parasite Suite - Works of social-computing and art.

* EDIT Abstract

  The project titled 'Parasite Suite' is about exploring the types of social enagement made likely, and open to manipulation through the use of networked computers. The project aims to consider both the negative and positive and negative aspects of social computing through sonically engaged art works, with the aim of presenting the materiality of computational processes and algorithmsm, as well as their attendant power heirachies, 'as they are' at present.

  The methods to achieve this are to delve into legitimate concerns about the current social-computing climate, making transparent some of the processes, such as data-logging, algorithmic metadata extraction from large data sets, sensory information and algorithmic surveillance and using them as key elements of the art works.

  By sonically and visually 'reifiying' the social manipulations that machines can introduce, altering their usage beyond common scenarios it is hoped that I can use 'social-computing' as a productive concept to explore the contours of the political and economic aspects of modern computing.
...
** EDIT Networked Experience and Digital Asethetics
   ...
   Parasite Suite is collection of socially-orientated art works exploring the role of technology in human relations. The works are inspired by anxieties about technology, now computerised relations are normal in the lives of most beings. The works particularly focus on concerns about government and institutional use of surveillance. Inspirations include critical theories of the digital[fn:43] , as well as works by composers and artists with an interest in the relationship between technology and society =such as...= . The project is realised as a set of installations that consider the types of social engagements for those entertaining a 'computational' mindset, a neologism which will be described.

    The notion of a 'computational' metaphor is concept introduced by David Berry[fn:42] The computational is an way of being in which the ordering of the world and concepts are developed withing the concepts of metaphors derived from the mediums which predominate interaction, in this case networked computer devices. The concept owes much to the work of Neil Postman, Mashall Mcluhan and is especially is a continuation of the idea of 'enframing' developed by Martin Heidegger in "The Question Concerning Technology"[fn:3].

 'Enframing' describes how technology mediates our engagements with the world, but also how qualities of a technology are adopted as metaphors for other sytems, paticularly economic and social. Furthermore, technology has a 'mode-of-revealing'[fn:4] that can import influence over both individuals and societies attitude to the world. In Hedidegger's description, 'enframing' limits understanding of the world, his suggested remedy to this is to limit the extent to which we treat technolgy as a means to mastery of a domain, which allows the use of a technnology to become an end in itslef.[fn:5]
...
** EDIT Networked Experience: - both mode of revealing and identity
   ...
   'Networked Experience' is the term for a 'mode-of-revealing' that plays a key role in computational experience. An enourmous amount of computational power is now directed towards the relaying, processsing and filtering of data sets, to be used in methods such as translation, aggregation and archiving and the use of computation to expand the function of communications has been ubiquitous since the invention of email. The quintessential example of real time archiving is Twitter, a near real-time worldwide message archive service. One that has till recently performed poorly as an archiving service but functioned efficently as a real time message sharing service. Berry describes is as a phenomenological message system[fn:7] because of the mode of thinking about twitter encourages users to describe their experience of a particular moment (with their smartphone) in the most immediate terms possible.
