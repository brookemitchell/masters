...
* DONE Introduction
    Parasite Suite is collection socially-orientated art works exploring human relations within digital technology. The project is realised as a set of art projects that consider the premise that, we live in a world where 'computationality' defines our mode of being (otherwise known as ontotheology)[fn:40]. The term 'computationality' can be broken into what I feel are its two defining aspects, an essence of relations based based on a networked experience, and an aesthetic based on abductive reasoning. I shall elaborate on the meanin of these terms networked experence and abductive reasoning further.
